...
- Telegram: normalize hyphenated command names to underscores in `setMyCommands` so skills like `export-session` register as valid `/export_session` bot commands. (#18683)
